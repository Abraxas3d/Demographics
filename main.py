...
activecallsigns = open(r"C:/Users/Kindl/OneDrive/Documents/Amateur-Radio-Demographics/active-callsigns.dat", "w+")
    ...
    with open('C:/Users/Kindl/OneDrive/Documents/Amateur-Radio-Demographics/HD.dat', 'r') as headers:
        ...
        for active_line in headers:
            ...
            if (active_list[5] == "A"):  # active licenses
                #print("Active License:", active_list[4])
                activecallsigns.write(active_list[4])
                activecallsigns.write("\n")
...
try:
    with open('C:/Users/Kindl/OneDrive/Documents/Amateur-Radio-Demographics/EN-wed.dat', 'r') as my_file:
        ...
        for my_line in my_file:
            ...
            if (my_list[5] == "L") & (my_list[23] == "I"):  # valid individual license? continue

                if (my_list[8] == ".") | (my_list[8] == ",") | (my_list[8] == ""):  # can't analyze these
                    punch_count += 1
                else:
                    # print(my_line)
                    ...
                    if (my_zipcode.population_by_race == None):
                        ...
                        if (random_number < prob_white):
                            ...
                            asian_count += 1
                        elif (random_number < prob_white + prob_black + prob_american_indian + prob_asian + prob_other_race):
                            other_count += 1
                        elif (random_number < prob_white + prob_black + prob_american_indian + prob_asian + prob_other_race + prob_two_or_more):
                            two_or_more_count += 1
